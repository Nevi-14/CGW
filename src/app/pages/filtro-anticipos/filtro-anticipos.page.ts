...
@Component({
  selector: 'app-filtro-anticipos',
  templateUrl: './filtro-anticipos.page.html',
  styleUrls: ['./filtro-anticipos.page.scss'],
})
export class FiltroAnticiposPage implements OnInit {

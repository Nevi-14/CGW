...
@Component({
  selector: 'app-control-adelanto-viaticos',
  templateUrl: './control-adelanto-viaticos.page.html',
  styleUrls: ['./control-adelanto-viaticos.page.scss'],
})
export class ControlAdelantoViaticosPage implements OnInit {
...
this.adelantoViaticosService.syncGetAdelantoViaticosToPromise().then(resp =>{
 this.alertasService.loadingDissmiss();
  ...
  async adelantoViaticos(){
    ...
    this.router.navigateByUrl('/inicio/adelanto-viaticos', {replaceUrl:true});
